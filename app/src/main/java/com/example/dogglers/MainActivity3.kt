...
import com.example.dogglers.databinding.ActivityMain3Binding
...
class MainActivity3 : AppCompatActivity() {
    ...
    private fun launchVertical() {
        listIntent = Intent(this, VerticalListActivity2::class.java)
        startActivity(listIntent)
    }

    private fun launchHorizontal() {
        listIntent = Intent(this, HorizontalListActivity2::class.java)
        startActivity(listIntent)
    }

    private fun launchGrid() {
        listIntent = Intent(this, GridListActivity2::class.java)
        startActivity(listIntent)
    }
