...
import com.example.dogglers.adapter.CatCardAdapter
import com.example.dogglers.adapter.DogCardAdapter
import com.example.dogglers.const.Layout
import com.example.dogglers.databinding.ActivityHorizontalListBinding

class HorizontalListActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.horizontalRecyclerView.adapter = CatCardAdapter(
            applicationContext,
            Layout.HORIZONTAL
        )
