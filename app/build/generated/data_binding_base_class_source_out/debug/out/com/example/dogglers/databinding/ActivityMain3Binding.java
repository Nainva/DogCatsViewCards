...
public final class ActivityMain3Binding implements ViewBinding {
  ...
  private ActivityMain3Binding(@NonNull ConstraintLayout rootView, @NonNull Button gridBtn,
  ...
  public static ActivityMain3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain3Binding((ConstraintLayout) rootView, gridBtn, horizontalBtn,
          verticalBtn);
    }
